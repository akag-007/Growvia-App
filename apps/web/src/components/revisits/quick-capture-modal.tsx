            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-xl glass-modal rounded-3xl overflow-hidden"
                    >
                        <form onSubmit={handleSubmit} className="p-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white placeholder:text-zinc-400 focus:ring-2 focus:ring-emerald-500/50 transition-all"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            value={formData.type}
                                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:ring-2 focus:ring-emerald-500/50 transition-all appearance-none cursor-pointer"
                                        >
                                        ...
                                        {formData.type === 'custom' && (
                                            <input
                                                ...
                                                className="w-full mt-2 bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white placeholder:text-zinc-400 focus:ring-2 focus:ring-emerald-500/50 transition-all"
                                            />
                                        )}
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:ring-2 focus:ring-emerald-500/50 transition-all cursor-pointer text-sm"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white placeholder:text-zinc-400 focus:ring-2 focus:ring-emerald-500/50 transition-all resize-none"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-5 py-3 text-white placeholder:text-zinc-400 focus:ring-2 focus:ring-emerald-500/50 transition-all"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 flex gap-3">
                                <button
                                    type="button"
                                    className="flex-1 px-4 py-3 bg-white/5 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all"
                                >
                                    Cancel
                                </button>
                                <button
